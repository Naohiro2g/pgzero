...
class Storage(dict):
    ...
    def __init__(self, filename=None):
        ...
        self._set_filename_from_path(self.path)
        self.storages.append(self)
        self._ensure_save_path()  # Create a Storage Directory at the very first use. moved from save_all
    ...
    def _set_filename_from_path(self, file_path):
        ...
        fn_hash = sha1(file_path.encode('utf-8')).hexdigest()[:8]
